...
//         (uint8 stat1Free, uint8 stat2Free, uint8 stat3Free) = rpgItemNFT.getTokenStats(tokenId);
...
//             rpgItemNFT.nextUpgrade(tokenId, Upgrade.Type.Paid);

//             (uint8 stat1Paid, uint8 stat2Paid, uint8 stat3Paid) = rpgItemNFT.getTokenStats(tokenId);
